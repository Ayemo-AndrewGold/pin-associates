      ...
      <main>
        ...
        >
          <div className="container-pin relative z-10 text-center">
            <span className="section-label section-label-gold mb-6 inline-flex">Blog & Insights</span>
            <h1 className="font-heading font-extrabold text-white text-4xl md:text-5xl leading-tight mb-4">
              Knowledge That Helps You Pass and Grow
            </h1>
            <p className="text-white/65 text-lg max-w-xl mx-auto">
              Exam strategies, accounting insights, ICAN and ACCA updates, tax law changes,
              and career advice from practitioners who teach for a living.
            </p>
          </div>
